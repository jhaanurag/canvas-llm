        ...
        >
            {!isCustom ? (
                ...
                <div className="flex items-center gap-1 px-1 py-0.5">
                    <Input
                        autoFocus
                        className={clsx("h-8 w-56 border border-[#1b2b33]/25 bg-[#fffaf2] text-[11px] font-medium placeholder:text-[#617177] focus-visible:ring-2", controlRadiusClass)}
                    ...
                    <Button
                        size="sm"
                        className={clsx("h-8 bg-[color:var(--node-accent)] px-4 text-[11px] font-semibold uppercase tracking-[0.12em] text-[#f8fffd] hover:bg-[color:var(--node-accent-dark)]", controlRadiusClass)}
                    ...
                    <Button
                        size="sm"
                        variant="ghost"
                        className={clsx("h-8 border border-red-500/25 px-2 text-red-700 hover:bg-red-100", controlRadiusClass)}
